...
DOMAIN_ID=${1:-56}
echo "Uruchamianie aplikacji w sieci ROS_DOMAIN_ID: $DOMAIN_ID"

# Odblokowanie dostępu do ekranu dla Dockera
xhost +local:root

# Uruchomienie kontenera z przekazaniem domeny i dynamiczną nazwą
